...
public class IntListTest {
    ...
    public void testSquareListRecursive() {
        ...
        IntList orig = IntList.list(0,1,2,3,4);
        IntList squared = IntList.squareListRecursive(orig);
        assertEquals(IntList.list(0,1,4,9,16), squared);
        // TODO: test for non-destructiveness
        assertEquals(IntList.list(0,1,2,3,4), orig);
        // TODO: remove placeholder
        assertTrue(orig != squared);
    }
